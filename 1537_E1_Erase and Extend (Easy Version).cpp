...
// 1st submission idea was wrong
// 1st -> erase from back until we get a greater char by s[0] and then replicate until k
// Correct idea is to try every prefix until we find greater char by s[0]
